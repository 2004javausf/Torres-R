...
public class IteratorDemo {
	/* Iterator
	 * Anything that can be used as a subject of a for each loop uses an iterator
	 * Aka they implement the Iterable interface
	 * Every collection has an iterator that allows traversal betweeen elements and
